...
import com.ktknahmet.final_project.ui.base.FullScreenDialogFragment

@Suppress("unused")
abstract class BaseMyFullScreenDialog<VB : ViewBinding> : FullScreenDialogFragment() {
    companion object {
    ...
    abstract fun convertView(vb: VB, dialog: BaseMyFullScreenDialog<VB>)
    ...
    open fun setDialogTheme(@StyleRes theme: Int): BaseMyFullScreenDialog<*> {
        this.dialogTheme = theme
        return this
    }

    open fun setMargin(margin: Int): BaseMyFullScreenDialog<*> {
        this.margin = margin
        return this
    }

    open fun setWidth(width: Int): BaseMyFullScreenDialog<*> {
        this.width = width
        return this
    }

    open fun setHeight(height: Int): BaseMyFullScreenDialog<*> {
        this.height = height
        return this
    }

    open fun setDimAmount(dimAmount: Float): BaseMyFullScreenDialog<*> {
        this.dimAmount = dimAmount
        return this
    }

    open fun setGravity(gravity: Int): BaseMyFullScreenDialog<*> {
        this.gravity = gravity
        return this
    }

    open fun setOutCancel(outCancel: Boolean): BaseMyFullScreenDialog<*> {
        this.outCancel = outCancel
        return this
    }

    open fun setAnimStyle(@StyleRes animStyle: Int): BaseMyFullScreenDialog<*> {
        this.animStyle = animStyle
        return this
    }

    open fun show(manager: FragmentManager): BaseMyFullScreenDialog<*> {
