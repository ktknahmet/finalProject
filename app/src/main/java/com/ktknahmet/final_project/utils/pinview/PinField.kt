...
open class PinField : AppCompatEditText {
    ...
    private val defaultWidth = PinUtils.dpToPx(60f).toInt()
    ...
    var lineThickness = PinUtils.dpToPx(1.0f)
        set(value) {
            field = value
    ...
    private var highlightPaintColor = ContextCompat.getColor(context, R.color.pinFieldLibraryAccent)
        set(value) {
            field = value
    ...
    protected var yPadding = PinUtils.dpToPx(10f)
    ...
    private var onTextCompleteListener: OnTextCompleteListener? = null

    private var fieldBgColor = ContextCompat.getColor(context, R.color.pinFieldLibraryAccent)
        set(value) {
            field = value
    ...
    private fun initParams(attr: AttributeSet) {
        ...
        try {
            ...
            highlightSingleFieldType = HighlightType.getEnum(
                a.getInt(
                    R.styleable.PinField_highlightType,
